...
// Hack for falling under the map in arenas.
float underMapValueZ;
switch (plrMover->GetMapId())
{
    case 617: underMapValueZ = 3.0f; break; // Dalaran Sewers Arena
    case 618: underMapValueZ = 28.0f; break; // Ring of Valor Arena
    case 562: underMapValueZ = -10.0f; break; // Blade's Edge Arena
    case 559: underMapValueZ = -18.0f; break; // Nagrand Arena
    case 572: underMapValueZ = 28.0f; break; // Ruins of Lordaeron Arena
    ...
    default:  underMapValueZ = -500.0f; break;
        ...
        if (movementInfo.pos.GetPositionZ() < -500.0f)
        {
            if (underMapValueZ != -500) // Only Case Values
            {
                ...
                if (plrMover->GetMapId() == 562) // Blade's Edge Arena
